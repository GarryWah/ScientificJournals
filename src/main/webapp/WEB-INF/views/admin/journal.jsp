    ...
    <div class="col-md-7 col-xs-12">
        ...
        <c:forEach items="${journals.content}" var="journal">
            <div class="row">
                ...
                <div class="col-md-2 col-xs-2"><a class="btn btn-danger" href="/admin/journal/delete/${journal.id}<custom:allParams/>">delete</a></div>
                <div class="col-md-2 col-xs-2"><a class="btn btn-danger" href="/admin/journal/update/${journal.id}<custom:allParams/>">update</a></div>
