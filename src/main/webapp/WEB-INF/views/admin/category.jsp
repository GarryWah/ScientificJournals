    ...
    <div class="col-md-7 col-xs-12">
        ...
        <c:forEach items="${categories.content}" var="category">
            <div class="row">
                ...
                <div class="col-md-3 col-xs-3"><a class="btn btn-danger" href="/admin/category/update/${category.id}<custom:allParams/>">update</a></div>
                <div class="col-md-3 col-xs-3"><a class="btn btn-danger" href="/admin/category/show/title/${category.id}<custom:allParams/>">Show journal titles</a></div>
            </div>
        </c:forEach>
    </div>
