    ...
    <div class="col-md-7 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <form:form class="form-horizontal" action="/admin/category/show/title/${category.id}" method="POST"
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <a class="btn btn-primary"
                               href="/admin/category/show/title/${category.id}/cancel">Cancel</a>
                        </div>
                    </div>
                </form:form>
            </div>
        ...
        <c:forEach items="${category.titles}" var="title">
            <div class="row">
                ...
                <div class="col-md-3 col-xs-3"><a class="btn btn-danger"
                                                  href="/admin/category/show/title/${category.id}/update/${title.id}">update</a>
                </div>
                <div class="col-md-3 col-xs-3"><a class="btn btn-danger"
                                                  href="/admin/category/show/title/${category.id}/delete/${title.id}">delete</a>
                </div>
                <div class="col-md-3 col-xs-3"><a class="btn btn-danger" href="/admin/title/show/journal/${title.id}">Show
                    volumes</a></div>
