    ...
    <div class="col-md-7 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <form:form class="form-horizontal" action="/admin/title/show/journal/${journalTitle.id}" method="POST" modelAttribute="Add">
...
<%--                        <label for="id" class="col-sm-2 control-label">Journal id</label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <a class="btn btn-primary" href="/admin/title/show/journal/${journalTitle.id}/cancel">Cancel</a>
                        </div>
                    </div>
                </form:form>
            </div>
        ...
        <c:forEach items="${journalTitle.journals}" var="journal">
            <div class="row">
                ...
                <div class="col-md-3 col-xs-3"><a class="btn btn-danger" href="/admin/title/show/journal/${journalTitle.id}/update/${journal.id}">update volume</a></div>
                <div class="col-md-3 col-xs-3"><a class="btn btn-danger" href="/admin/title/show/journal/${journalTitle.id}/delete/${journal.id}">delete volume</a></div>
