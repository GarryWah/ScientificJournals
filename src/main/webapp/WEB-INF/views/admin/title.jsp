            ...
            <c:forEach items="${titles.content}" var="title">
                <div class="row">
                    ...
                    <div class="col-md-2 col-xs-2"><a class="btn btn-danger"
                                                      href="/admin/title/delete/${title.id}<custom:allParams/>">delete</a>
                    </div>
                    <div class="col-md-2 col-xs-2"><a class="btn btn-danger"
                                                      href="/admin/title/update/${title.id}<custom:allParams/>">update</a>
                    </div>
                    <div class="col-md-2 col-xs-2"><a class="btn btn-danger"
                                                      href="/admin/title/show/journal/${title.id}<custom:allParams/>">Show
                        volumes</a></div>
                </div>
            </c:forEach>
        </div>
