    ...
    <div class="col-md-7 col-xs-12">
            ...
            <div class="col-md-12 col-xs-12">
                <form:form class="form-horizontal" action="/admin/user" method="POST" modelAttribute="user">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            <label for="firstName" class="col-sm-offset-2 col-sm-10"><form:errors
                        ...
                        <div class="form-group">
                            <label for="lastName" class="col-sm-offset-2 col-sm-10"><form:errors
                                    path="lastName"/></label>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-offset-2 col-sm-10"><form:errors
                                    path="username"/></label>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <button type="submit" name="action" value="search" class="btn btn-default">Search by login
                            </button>
        ...
        <c:forEach items="${users.content}" var="user">
            <div class="row">
                ...
                <div class="col-md-2 col-xs-2"><a class="btn btn-warning" href="/admin/user/order/${user.id}">Bucket</a>
                </div>
                <div class="col-md-2 col-xs-2"><a class="btn btn-warning"
                                                  href="/admin/user/update/${user.id}<custom:allParams/>">update</a>
                </div>
                <div class="col-md-2 col-xs-2"><a class="btn btn-danger"
                                                  href="/admin/user/delete/${user.id}<custom:allParams/>">delete</a>
                </div>
            </div>
        </c:forEach>
    </div>
