...
<div class="row">
	<div class="col-sm-12 col-xs-12">
		<form:form class="form-horizontal" action="/login" method="POST">
			...
			<div class="col-md-3 col-xs-3"><a class="btn btn-danger" href="/logout">logout</a></div>
			<div class="col-md-3 col-xs-3"><a class="btn btn-warning" href="/registration">Or register</a></div>
		</form:form>
	</div>
</div>